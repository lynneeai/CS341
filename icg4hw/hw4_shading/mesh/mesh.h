...
class Mesh : public Material, public Light {
    ...
    private:
        void BindShader(GLuint program_id) {
            ...
            texture_1d_id_ = glGetUniformLocation(active_program_id_,"tex1D");
            glUniform1i(texture_1d_id_,0/*GL_TEXTURE0*/);

            // TODO 3.1 bind texture_2d_id_ for artistic shading

            texture_2d_id_ = glGetUniformLocation(active_program_id_,"tex2D");
            glUniform1i(texture_2d_id_,1/*GL_TEXTURE1*/);
