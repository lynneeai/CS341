...
//#define STRIP_CODE
    ...
    motionVector = vec2(currentPosition.x/currentPosition.w - previousPosition.x/previousPosition.w,
                        currentPosition.y/currentPosition.w - previousPosition.y/previousPosition.w);
}
