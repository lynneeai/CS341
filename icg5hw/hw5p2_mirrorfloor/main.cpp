...
void Display() {
    ...
    vec3 mirrored_cam_pos = vec3(2.0f, 2.0f, -2.0f);
    // TODO: create new VP for mirrored camera
    mat4 new_view = lookAt(mirrored_cam_pos, cam_look, cam_up);
    mat4 new_view_projection = projection_matrix * new_view;
